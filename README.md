...
How to find files:
In same directory as readme.md -> you will find the folder name sql turn in which has: the table, sql operations, and data, then in the app folder you will find the rest of the project code
